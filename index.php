...
try {
    switch ($controller) {
        ...
        case 'admin':
            ...
            $superAdminOnly = ['users', 'admins', 'settings', 'ai'];

            if (in_array($action, $superAdminOnly) && $adminRole !== 'superadmin') {
            ...
            switch ($action) {
                ...
                case 'permissions':
                    ...
                    break;
                case 'profile':
                    if ($param === 'password') $adminCtrl->profilePassword();
                    else redirect('admin');
                    break;
                default:
                    $adminCtrl->dashboard();
        ...
        default:
            header('HTTP/1.0 404 Not Found');
            require __DIR__ . '/views/frontend/errors/404.php';
    }
} catch (Exception $e) {
