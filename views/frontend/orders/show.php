        ...
        <div class="card-body p-4">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-1"><?= htmlspecialchars(($order['billing_first_name'] ?? $order['shipping_first_name']) . ' ' . ($order['billing_last_name'] ?? $order['shipping_last_name'])) ?></p>
                    <p class="mb-1"><?= htmlspecialchars($order['billing_address1'] ?? $order['shipping_address1']) ?></p>
                    <?php if (!empty($order['billing_address2'] ?? $order['shipping_address2'] ?? '')): ?>
                    <p class="mb-1"><?= htmlspecialchars($order['billing_address2'] ?? $order['shipping_address2']) ?></p>
                    <?php endif; ?>
                    <p><?= htmlspecialchars(($order['billing_city'] ?? $order['shipping_city']) . ', ' . ($order['billing_county'] ?? $order['shipping_county']) . ' ' . ($order['billing_zip'] ?? $order['shipping_zip'])) ?></p>
                </div>
            </div>
        </div>
    </div>
