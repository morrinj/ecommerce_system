...
/** @var array $salesData */
$pageTitle = 'Dashboard'; require __DIR__ . '/partials/header.php'; ?>

<?php if (!empty($_SESSION['force_password_change'])): ?>
<div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
    <i class="bi bi-shield-exclamation me-2"></i>
    <strong>Security Notice:</strong> Your password is over 90 days old. Please
    <a href="<?= url('admin/profile/password') ?>" class="alert-link">change your password</a> to maintain account security.
